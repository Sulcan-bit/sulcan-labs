...
CREATE TABLE "HeavyOilInputs" (
    ...
    "cond_c2_pct" DOUBLE PRECISION,
    "cond_c3_pct" DOUBLE PRECISION,
    "cond_c4_pct" DOUBLE PRECISION,
    ...
    "cond2_density_kg_m3" DOUBLE PRECISION,
    "cond2_sulphur_pct" DOUBLE PRECISION,
    ...
    "terminalhub_premium_crude_value_usd_bbl" DOUBLE PRECISION NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
